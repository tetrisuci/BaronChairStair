 ...
 *
 * There are four things to do here now — the daily's three puzzles, a rush,
 * a 1v1, the whole archive — and until this existed the way to any of them was
 * a row of small buttons in the masthead, which is furniture rather than a
 * front door. Discord's side collapsed to one `/puzzle` for the same reason:
 * one way in, and the choosing happens where the game is.
 *
